                ...
                <ul id="left-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul id="recipe-menu" class="dropdown-menu" role="menu" aria-labelledby="recipe-dropdown">
                            ...
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Asian</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Mexican</a></li>
                    ...
                    <li @if($page == 'planner') class="active" @endif><a href="{{ url('/menu') }}">Meal Planner</a></li>
                </ul>
                    ...
                    <ul id="right-menu">
                        ...
                        <li id="user-profile">Hello, {{ Auth::user()->username }} <span class="caret"></span>
                            <div id="user-settings">
                                <a id="change-settings" href="{{ url('user/settings') }}">Account Settings</a>
                                <a id="logout" href="{{ url('logout') }}" class="button">Logout</a>
                            </div>
                        </li>
                    </ul>
                @endif
