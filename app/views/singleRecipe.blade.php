...
<div id="recipe-infobox" class="clearfix">
    ...
    <div id="recipe-additional">
        ...
        <div id="recipe-notice">
            <a href="{{ url('recipe/'.$recipe->new_recipe_id) }}">
                Note: This recipe has been updated since you added to your cookbook.
            </a>
        </div>
        @endif
...
<div id="recipe-menubar" class="clearfix">
    <p id="cookbook-addremove">
        ...
        <a href="{{ url('recipe/remove/' . $recipe->id) }}" class="button"><span
                class="glyphicon glyphicon-minus"></span> In Cookbook</a>
        @else
        <a href="{{ url('recipe/add/'.$recipe->id) }}" class="button"><span class="glyphicon glyphicon-plus"></span> Add
            To Cookbook</a>
        @endif
    </p>
    ...
    <p id="menu-addremove">
        ...
        <a href="{{ url('meal/remove/'.$recipe->id) }}" class="button"><span class="glyphicon glyphicon-minus"></span>
            In Meal</a>
        @else
        <a href="{{ url('meal/add/'.$recipe->id) }}" class="button"><span class="glyphicon glyphicon-plus"></span> Add
            To Meal</a>
        @endif
    </p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <p class="col-sm-8 col-sm-offset-4 edit-recipe-error">{{ $errors->editRecipe->first('name')
                            }}</p>
                        @endif
                        <label for="editrecipe-name" class="col-sm-4">Name</label>

                        <div class="col-sm-8">
                            {{ Form::text('name', $recipe->name, array('id' => 'editrecipe-name', 'placeholder' =>
                            'Recipe Name')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::textarea('additional_text', $recipe->additional_text, array('id' =>
                            'editrecipe-additionaltext', 'placeholder' => 'Additional Text')) }}
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="row" id="newrecipe-tags">
                                ...
                                <div class="col-sm-6">
                                    <div class="checkbox">
                                        <label>
                                            <input id="tags" name="tags[]" value="{{ $tag->id }}"
                                                   type="checkbox" <?php if ($recipe->hasTag($tag->id)) echo 'checked'; ?> />
                                            {{ $tag->name }}
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {{ Form::text('prep_time', $recipe->prep_time, array('id' => 'editrecipe-preptime',
                            'placeholder' => 'Ex: 1hr 40min')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {{ Form::text('cook_time', $recipe->cook_time, array('id' => 'editrecipe-cooktime',
                            'placeholder' => 'Ex: 1hr 40min')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {{ Form::text('total_time', $recipe->total_time, array('id' => 'editrecipe-totaltime',
                            'placeholder' => 'Ex: 1hr 40min')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('url', $recipe->url, array('id' => 'editrecipe-url', 'placeholder' =>
                            'http://link.to/recipe')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::textarea('ingredients', $recipe->ingredients, array('id' =>
                            'editrecipe-ingredients', 'placeholder' => 'Ingredients')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::textarea('directions', $recipe->directions, array('id' => 'editrecipe-directions',
    ...
    <div id="recipe-personalnote">
        ...
        <p id="add-note">Have something you do different? <a href="#" data-toggle="modal" data-target="#personalNote">Add
                a Personal Note</a>
            @endif
        ...
        <div class="modal fade" id="personalNote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content clearfix">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Personal Note
                            <small>Do something different?</small>
                        </h4>
                    </div>
                    <div class="modal-body">
                        {{ Form::textarea('personal_note', $note->getText(), array('class' => 'form-control',
